          ...
          <div className="max-w-7xl mx-auto text-center">
            ...
            >
              ...
              <div className="flex justify-center items-center space-x-8 mb-12">
                ...
                <div className="text-center">
                  <div className="text-3xl font-bold text-white mb-1">5</div>
                  <div className="text-blue-200 text-sm">Success Processes</div>
                </div>
              </div>
            </motion.div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              >
                <Link href="/manuals" className="block">
                  <div className="bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20 hover:border-blue-400/50 transition-all duration-300 h-full shadow-xl hover:shadow-2xl">
                    <div className="w-20 h-20 bg-gradient-to-r from-blue-500 to-emerald-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                      <BookOpen className="w-10 h-10 text-white" />
                    </div>
                    <h3 className="text-2xl font-bold text-white mb-4">EVnation Manuals</h3>
                    <p className="text-gray-300 text-lg mb-6 leading-relaxed">
                      Access comprehensive technical documentation, company policies, and operational guidelines.
                    </p>
                    <div className="flex items-center justify-between">
                      <span className="text-blue-300 font-medium">3 Manuals Available</span>
              ...
              >
                <Link href="/etiquette" className="block">
                  <div className="bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20 hover:border-emerald-400/50 transition-all duration-300 h-full shadow-xl hover:shadow-2xl">
                    <div className="w-20 h-20 bg-gradient-to-r from-emerald-500 to-teal-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                      <Users className="w-10 h-10 text-white" />
                    </div>
                    <h3 className="text-2xl font-bold text-white mb-4">Workplace Etiquette</h3>
                    <p className="text-gray-300 text-lg mb-6 leading-relaxed">
              ...
              >
                <Link href="/processes" className="block">
                  <div className="bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20 hover:border-purple-400/50 transition-all duration-300 h-full shadow-xl hover:shadow-2xl">
                    <div className="w-20 h-20 bg-gradient-to-r from-purple-500 to-indigo-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
              ...
              >
                <Link href="/programs" className="block">
                  <div className="bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20 hover:border-orange-400/50 transition-all duration-300 h-full shadow-xl hover:shadow-2xl">
                    ...
                    <h3 className="text-2xl font-bold text-white mb-4">Programs & Tools</h3>
                    <p className="text-gray-300 text-lg mb-6 leading-relaxed">
              ...
              >
                <Link href="/contact" className="block">
                  <div className="bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20 hover:border-pink-400/50 transition-all duration-300 h-full shadow-xl hover:shadow-2xl">
                    <div className="w-20 h-20 bg-gradient-to-r from-pink-500 to-rose-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
