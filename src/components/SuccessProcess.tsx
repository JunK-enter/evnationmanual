    ...
    <section className="px-4 sm:px-6 lg:px-8 py-20">
      <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <div className="text-center mb-8">
                <div className="flex items-center justify-center space-x-3 mb-4">
                  <div className="w-16 h-16 bg-gradient-to-r from-blue-500 to-emerald-600 rounded-2xl flex items-center justify-center">
                    <Play className="w-8 h-8 text-white" />
                  </div>
                  <div className="text-left">
                    <h3 className="text-2xl font-bold text-white">{flow.title}</h3>
                    <p className="text-blue-200">{flow.description}</p>
                  </div>
                </div>
              ...
              <div className="relative">
                {/* Connection Lines */}
                <div className="absolute top-1/2 left-0 right-0 h-0.5 bg-gradient-to-r from-blue-500/30 to-emerald-500/30 -translate-y-1/2 hidden lg:block"></div>
                
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 2xl:grid-cols-8 gap-6 relative z-10">
                  {flow.nodes.map((node, nodeIndex) => (
                    <motion.div
                      ...
                      viewport={{ once: true }}
                      transition={{ duration: 0.6, delay: nodeIndex * 0.1 }}
                      whileHover={{ y: -8 }}
                      className="group"
                    >
                      <div className="relative">
                        {/* Node */}
                        <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/20 hover:border-blue-400/50 transition-all duration-300 shadow-xl hover:shadow-2xl">
                          {/* Step Number */}
                          ...
                          {/* Icon */}
                          <div className={`w-12 h-12 bg-gradient-to-r ${getCategoryColor(node.category)} rounded-xl flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300`}>
                          ...
                          {/* Content */}
                          <h4 className="text-sm font-bold text-white mb-2 group-hover:text-blue-300 transition-colors line-clamp-2 leading-tight">
                            {node.title}
                          </h4>
                        ...
                        <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2">
                          <button className="w-6 h-6 bg-gradient-to-r from-blue-500 to-emerald-600 rounded-full flex items-center justify-center text-white text-xs hover:scale-110 transition-transform duration-300 shadow-lg">
              ...
              <div className="flex justify-center mt-8">
                <button className="px-6 py-3 bg-gradient-to-r from-blue-500 to-emerald-600 text-white font-medium rounded-xl hover:from-blue-600 hover:to-emerald-700 transition-all duration-300 transform hover:scale-105">
                  View Full Process
                </button>
              </div>
            </motion.div>
        ...
        <motion.div
          ...
          className="mt-20 bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20 text-center"
        >
